...
> [!IMPORTANT]
> **安全群組最小化**：後續章節的開發預覽由 Antigravity Ports 處理，正式發布由 Cloudflare Tunnel 處理，因此**絕對不需要在晶創雲安全群組開放 3000、4000、8000、80 或 443 給公網**。
...
| **Ingress (入站)** | TCP | `3000`, `4000`, `8000` | `0.0.0.0/0` | 應用服務埠號 | ❌ **禁止（使用 Tunnel 轉發）** |
