    ...
    sidebar: [
      {
        ...
        items: [
          ...
          { text: '💻 第 02 章：開發連線與極速全端環境', link: '/guide/02_ssh_proxyjump_and_dev_env' },
          { text: '🧠 第 03 章：大腦串接：Taiwan AI 雲端模型', link: '/guide/03_taiwan_ai_api_integration' },
          { text: '🤖 第 04 章：核心實戰：自研 AI Agent Runtime', link: '/guide/04_ai_agent_runtime_engine' },
